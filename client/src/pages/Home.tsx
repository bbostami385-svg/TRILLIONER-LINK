        ...
        <div className="container max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            {isAuthenticated && user ? (
              <>
                <span className="text-sm text-muted-foreground">{t("home.welcomeUser").replace("{email}", user.email ?? "")}</span>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Card>
            <CardHeader>
              ...
              <CardTitle>{t("home.connect")}</CardTitle>
            </CardHeader>
            <CardContent>
              <CardDescription>
          ...
          <Card>
            <CardHeader>
              ...
              <CardTitle>{t("home.share")}</CardTitle>
            </CardHeader>
            <CardContent>
              <CardDescription>
          ...
          <Card>
            <CardHeader>
              ...
              <CardTitle>{t("home.create")}</CardTitle>
            </CardHeader>
            <CardContent>
              <CardDescription>
